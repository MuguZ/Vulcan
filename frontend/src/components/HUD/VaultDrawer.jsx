...
function VaultDrawer() {
  ...
  return (
    ...
    >
      ...
      <div style={{fontFamily: 'IBM Plex Mono', fontSize: '0.75rem', color: '#888', marginBottom: '30px'}}>
      ...
      <div className="paper-card" style={{flex: 1, transform: 'rotate(-0.3deg)', overflowY: 'auto'}}>
        ...
        <button
          ...
          style={{
            ...
            border: 'none', fontFamily: 'Big Shoulders Stencil', fontSize: '1.4rem', letterSpacing: '2px',
